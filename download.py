...
def find_model(model_name):
    ...
    Args:
        model_name (str): The name of the model or the local path to the model checkpoint.

    Returns:
        dict or torch.nn.Module: The pre-trained DiT model if found, or the loaded model from the local path.
