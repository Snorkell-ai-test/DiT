...
def create_diffusion(
    ...
    This function creates a diffusion model based on the provided parameters, including the timestep respacing, noise schedule, use of KL divergence, sigma scaling, prediction of starting point, sigma learning, and diffusion steps.
    ...
    Args:
        ...
        sigma_small (bool?): Whether to use small sigma. Defaults to False.
        predict_xstart (bool?): Whether to predict the starting point. Defaults to False.
